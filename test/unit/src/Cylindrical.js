...
QUnit.test( "constructor", function ( assert ) {
	...
	a = new GLMath.Cylindrical( radius, theta, y );
...
QUnit.test( "clone", function ( assert ) {
	...
	var theta = Math.PI;
	var y = 5;
	var a = new GLMath.Cylindrical( radius, theta, y );
	var b = a.clone();
...
QUnit.test( "copy", function ( assert ) {
	...
	var y = 5;
	var a = new GLMath.Cylindrical( radius, theta, y );
	var b = new GLMath.Cylindrical().copy( a );
...
QUnit.test( "setFromVector3", function ( assert ) {
	...
	var a = new GLMath.Cylindrical( 1, 1, 1 );
	var b = new GLMath.Vector3( 0, 0, 0 );
	var c = new GLMath.Vector3( 3, - 1, - 3 );
	var expected = new GLMath.Cylindrical( Math.sqrt( 9 + 9 ), Math.atan2( 3, - 3 ), - 1 );
