...
QUnit.test( "constructor" , function( assert ) {
	var a = new GLMath.Vector2();
	assert.ok( a.x == 0, "Passed!" );
	assert.ok( a.y == 0, "Passed!" );

	a = new GLMath.Vector2( x, y );
	assert.ok( a.x === x, "Passed!" );
	assert.ok( a.y === y, "Passed!" );
});

QUnit.test( "copy" , function( assert ) {
	var a = new GLMath.Vector2( x, y );
	var b = new GLMath.Vector2().copy( a );
...
QUnit.test( "add" , function( assert ) {
	var a = new GLMath.Vector2( x, y );
	var b = new GLMath.Vector2( -x, -y );

	a.add( b );
	assert.ok( a.x == 0, "Passed!" );
	assert.ok( a.y == 0, "Passed!" );

	var c = new GLMath.Vector2().addVectors( b, b );
...
QUnit.test( "sub" , function( assert ) {
	...
	var c = new GLMath.Vector2().subVectors( a, a );
...
QUnit.test( "rounding" , function( assert ) {
	assert.deepEqual( new GLMath.Vector2( -0.1, 0.1 ).floor(), new GLMath.Vector2( -1, 0 ), "floor .1" );
	assert.deepEqual( new GLMath.Vector2( -0.5, 0.5 ).floor(), new GLMath.Vector2( -1, 0 ), "floor .5" );
	assert.deepEqual( new GLMath.Vector2( -0.9, 0.9 ).floor(), new GLMath.Vector2( -1, 0 ), "floor .9" );

	assert.deepEqual( new GLMath.Vector2( -0.1, 0.1 ).ceil(), new GLMath.Vector2( 0, 1 ), "ceil .1" );
	assert.deepEqual( new GLMath.Vector2( -0.5, 0.5 ).ceil(), new GLMath.Vector2( 0, 1 ), "ceil .5" );
	assert.deepEqual( new GLMath.Vector2( -0.9, 0.9 ).ceil(), new GLMath.Vector2( 0, 1 ), "ceil .9" );

	assert.deepEqual( new GLMath.Vector2( -0.1, 0.1 ).round(), new GLMath.Vector2( 0, 0 ), "round .1" );
	assert.deepEqual( new GLMath.Vector2( -0.5, 0.5 ).round(), new GLMath.Vector2( 0, 1 ), "round .5" );
	assert.deepEqual( new GLMath.Vector2( -0.9, 0.9 ).round(), new GLMath.Vector2( -1, 1 ), "round .9" );

	assert.deepEqual( new GLMath.Vector2( -0.1, 0.1 ).roundToZero(), new GLMath.Vector2( 0, 0 ), "roundToZero .1" );
	assert.deepEqual( new GLMath.Vector2( -0.5, 0.5 ).roundToZero(), new GLMath.Vector2( 0, 0 ), "roundToZero .5" );
	assert.deepEqual( new GLMath.Vector2( -0.9, 0.9 ).roundToZero(), new GLMath.Vector2( 0, 0 ), "roundToZero .9" );
	assert.deepEqual( new GLMath.Vector2( -1.1, 1.1 ).roundToZero(), new GLMath.Vector2( -1, 1 ), "roundToZero 1.1" );
	assert.deepEqual( new GLMath.Vector2( -1.5, 1.5 ).roundToZero(), new GLMath.Vector2( -1, 1 ), "roundToZero 1.5" );
	assert.deepEqual( new GLMath.Vector2( -1.9, 1.9 ).roundToZero(), new GLMath.Vector2( -1, 1 ), "roundToZero 1.9" );
});
...
QUnit.test( "length/lengthSq", function( assert ) {
	var a = new GLMath.Vector2( x, 0 );
	var b = new GLMath.Vector2( 0, -y );
	var c = new GLMath.Vector2();
...
QUnit.test( "multiply/divide", function ( assert ) {
	...
	var a = new GLMath.Vector2( x, y );
	var b = new GLMath.Vector2( 2 * x, 2 * y );
	var c = new GLMath.Vector2( 4 * x, 4 * y );
