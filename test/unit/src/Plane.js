...
QUnit.test( "copy" , function( assert ) {
	var a = new GLMath.Plane( new GLMath.Vector3( x, y, z ), w );
	var b = new GLMath.Plane().copy( a );
...
QUnit.test( "set" , function( assert ) {
	...
	var b = a.clone().set( new GLMath.Vector3( x, y, z ), w );
	assert.ok( b.normal.x == x, "Passed!" );
	assert.ok( b.normal.y == y, "Passed!" );
	assert.ok( b.normal.z == z, "Passed!" );
	assert.ok( b.constant == w, "Passed!" );
...
QUnit.test( "setFromNormalAndCoplanarPoint" , function( assert ) {
	...
	var a = new GLMath.Plane().setFromNormalAndCoplanarPoint( normal, zero3 );
...
QUnit.test( "normalize" , function( assert ) {
	var a = new GLMath.Plane( new GLMath.Vector3( 2, 0, 0 ), 2 );

	a.normalize();
	assert.ok( a.normal.length() == 1, "Passed!" );
	assert.ok( a.normal.equals( new GLMath.Vector3( 1, 0, 0 ) ), "Passed!" );
	assert.ok( a.constant == 1, "Passed!" );
});
...
QUnit.test( "negate/distanceToPoint", function( assert ) {
	...
	a.normalize();
	assert.ok( a.distanceToPoint( new GLMath.Vector3( 4, 0, 0 ) ) === 3, "Passed!" );
	assert.ok( a.distanceToPoint( new GLMath.Vector3( 1, 0, 0 ) ) === 0, "Passed!" );
...
QUnit.test( "distanceToSphere" , function( assert ) {
	var a = new GLMath.Plane( new GLMath.Vector3( 1, 0, 0 ), 0 );

	var b = new GLMath.Sphere( new GLMath.Vector3( 2, 0, 0 ), 1 );

	assert.ok( a.distanceToSphere( b ) === 1, "Passed!" );

	a.set( new GLMath.Vector3( 1, 0, 0 ), 2 );
...
QUnit.test( "isInterestionLine/intersectLine", function( assert ) {
	...
	var l1 = new GLMath.Line3( new GLMath.Vector3( -10, 0, 0 ), new GLMath.Vector3( 10, 0, 0 ) );
	assert.ok( a.intersectsLine( l1 ), "Passed!" );
	assert.ok( a.intersectLine( l1 ).equals( new GLMath.Vector3( 0, 0, 0 ) ), "Passed!" );

	a = new GLMath.Plane( new GLMath.Vector3( 1, 0, 0 ), -3 );

	assert.ok( a.intersectsLine( l1 ), "Passed!" );
	assert.ok( a.intersectLine( l1 ).equals( new GLMath.Vector3( 3, 0, 0 ) ), "Passed!" );


	a = new GLMath.Plane( new GLMath.Vector3( 1, 0, 0 ), -11 );
...
QUnit.test( "projectPoint" , function( assert ) {
	...
	assert.ok( a.projectPoint( new GLMath.Vector3( 10, 0, 0 ) ).equals( zero3 ), "Passed!" );
	assert.ok( a.projectPoint( new GLMath.Vector3( -10, 0, 0 ) ).equals( zero3 ), "Passed!" );

	a = new GLMath.Plane( new GLMath.Vector3( 0, 1, 0 ), -1 );
	assert.ok( a.projectPoint( new GLMath.Vector3( 0, 0, 0 ) ).equals( new GLMath.Vector3( 0, 1, 0 ) ), "Passed!" );
	assert.ok( a.projectPoint( new GLMath.Vector3( 0, 1, 0 ) ).equals( new GLMath.Vector3( 0, 1, 0 ) ), "Passed!" );
...
QUnit.test( "applyMatrix4/translate", function( assert ) {
	...
	assert.ok( comparePlane( a.clone().applyMatrix4( m ), new GLMath.Plane( new GLMath.Vector3( 0, 1, 0 ), 0 ) ), "Passed!" );

	a = new GLMath.Plane( new GLMath.Vector3( 0, 1, 0 ), -1 );
	assert.ok( comparePlane( a.clone().applyMatrix4( m ), new GLMath.Plane( new GLMath.Vector3( -1, 0, 0 ), -1 ) ), "Passed!" );

	m.makeTranslation( 1, 1, 1 );
	assert.ok( comparePlane( a.clone().applyMatrix4( m ), a.clone().translate( new GLMath.Vector3( 1, 1, 1 ) ) ), "Passed!" );
});

QUnit.test( "equals", function ( assert ) {

	var a = new GLMath.Plane( new GLMath.Vector3( 1, 0, 0 ), 0 );
	var b = new GLMath.Plane( new GLMath.Vector3( 1, 0, 0 ), 1 );
	var c = new GLMath.Plane( new GLMath.Vector3( 0, 1, 0 ), 0 );
...
QUnit.test( "setFromCoplanarPoints", function ( assert ) {
	...
	var a = new GLMath.Plane();
	var v1 = new GLMath.Vector3( 2.0, 0.5, 0.25 );
	var v2 = new GLMath.Vector3( 2.0, - 0.5, 1.25 );
	var v3 = new GLMath.Vector3( 2.0, - 3.5, 2.2 );
