...
QUnit.test( "copyHex" , function( assert ){
    var c = new GLMath.Color();
    var c2 = new GLMath.Color(0xF5FFFA);
    c.copy(c2);
...
QUnit.test( "set", function ( assert ) {
	...
	var a = new GLMath.Color();
	var b = new GLMath.Color( 0.5, 0, 0 );
	var c = new GLMath.Color( 0xFF0000 );
	var d = new GLMath.Color( 0, 1.0, 0 );

	a.set( b );
	assert.ok( a.equals( b ), "Set with GLMath.Color instance" );
...
QUnit.test( "offsetHSL", function ( assert ) {
	...
	var a = new GLMath.Color( "hsl(120,50%,50%)" );
	var b = new GLMath.Color( 0.36, 0.84, 0.648 );
...
QUnit.test( "add", function ( assert ) {
	...
	var a = new GLMath.Color( 0x0000FF );
	var b = new GLMath.Color( 0xFF0000 );
	var c = new GLMath.Color( 0xFF00FF );
...
QUnit.test( "addScalar", function ( assert ) {
	...
	var a = new GLMath.Color( 0.1, 0.0, 0.0 );
	var b = new GLMath.Color( 0.6, 0.5, 0.5 );
...
QUnit.test( "sub", function ( assert ) {
	...
	var a = new GLMath.Color( 0x0000CC );
	var b = new GLMath.Color( 0xFF0000 );
	var c = new GLMath.Color( 0x0000AA );
...
QUnit.test( "multiply", function ( assert ) {
	...
	var a = new GLMath.Color( 1, 0, 0.5 );
	var b = new GLMath.Color( 0.5, 1, 0.5 );
	var c = new GLMath.Color( 0.5, 0, 0.25 );
...
QUnit.test( "multiplyScalar", function ( assert ) {
	...
	var a = new GLMath.Color( 0.25, 0, 0.5 );
	var b = new GLMath.Color( 0.5, 0, 1 );
...
QUnit.test( "equals", function ( assert ) {
	...
	var a = new GLMath.Color( 0.5, 0.0, 1.0 );
	var b = new GLMath.Color( 0.5, 1.0, 0.0 );
...
QUnit.test( "toJSON", function ( assert ) {
	...
	var a = new GLMath.Color( 0.0, 0.0, 0.0 );
	var b = new GLMath.Color( 0.0, 0.5, 0.0 );
	var c = new GLMath.Color( 1.0, 0.0, 0.0 );
	var d = new GLMath.Color( 1.0, 1.0, 1.0 );
