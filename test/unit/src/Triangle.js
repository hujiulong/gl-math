...
QUnit.test( "copy" , function( assert ) {
	var a = new GLMath.Triangle( one3.clone().negate(), one3.clone(), two3.clone() );
	var b = new GLMath.Triangle().copy( a );
...
QUnit.test( "area" , function( assert ) {
	...
	a = new GLMath.Triangle( new GLMath.Vector3( 0, 0, 0 ), new GLMath.Vector3( 1, 0, 0 ), new GLMath.Vector3( 0, 1, 0 ) );
	assert.ok( a.area() == 0.5, "Passed!" );

	a = new GLMath.Triangle( new GLMath.Vector3( 2, 0, 0 ), new GLMath.Vector3( 0, 0, 0 ), new GLMath.Vector3( 0, 0, 2 ) );
	assert.ok( a.area() == 2, "Passed!" );

	// colinear triangle.
	a = new GLMath.Triangle( new GLMath.Vector3( 2, 0, 0 ), new GLMath.Vector3( 0, 0, 0 ), new GLMath.Vector3( 3, 0, 0 ) );
	assert.ok( a.area() == 0, "Passed!" );
});
...
QUnit.test( "midpoint" , function( assert ) {
	...
	assert.ok( a.midpoint().equals( new GLMath.Vector3( 0, 0, 0 ) ), "Passed!" );

	a = new GLMath.Triangle( new GLMath.Vector3( 0, 0, 0 ), new GLMath.Vector3( 1, 0, 0 ), new GLMath.Vector3( 0, 1, 0 ) );
	assert.ok( a.midpoint().equals( new GLMath.Vector3( 1/3, 1/3, 0 ) ), "Passed!" );

	a = new GLMath.Triangle( new GLMath.Vector3( 2, 0, 0 ), new GLMath.Vector3( 0, 0, 0 ), new GLMath.Vector3( 0, 0, 2 ) );
	assert.ok( a.midpoint().equals( new GLMath.Vector3( 2/3, 0, 2/3 ) ), "Passed!" );
});

QUnit.test( "normal" , function( assert ) {
	var a = new GLMath.Triangle();

	assert.ok( a.normal().equals( new GLMath.Vector3( 0, 0, 0 ) ), "Passed!" );

	a = new GLMath.Triangle( new GLMath.Vector3( 0, 0, 0 ), new GLMath.Vector3( 1, 0, 0 ), new GLMath.Vector3( 0, 1, 0 ) );
	assert.ok( a.normal().equals( new GLMath.Vector3( 0, 0, 1 ) ), "Passed!" );

	a = new GLMath.Triangle( new GLMath.Vector3( 2, 0, 0 ), new GLMath.Vector3( 0, 0, 0 ), new GLMath.Vector3( 0, 0, 2 ) );
	assert.ok( a.normal().equals( new GLMath.Vector3( 0, 1, 0 ) ), "Passed!" );
});
...
QUnit.test( "barycoordFromPoint" , function( assert ) {
	...
	var bad = new GLMath.Vector3( -2, -1, -1 );
	...
	a = new GLMath.Triangle( new GLMath.Vector3( 0, 0, 0 ), new GLMath.Vector3( 1, 0, 0 ), new GLMath.Vector3( 0, 1, 0 ) );
	assert.ok( a.barycoordFromPoint( a.a ).equals( new GLMath.Vector3( 1, 0, 0 ) ), "Passed!" );
	assert.ok( a.barycoordFromPoint( a.b ).equals( new GLMath.Vector3( 0, 1, 0 ) ), "Passed!" );
	assert.ok( a.barycoordFromPoint( a.c ).equals( new GLMath.Vector3( 0, 0, 1 ) ), "Passed!" );
	assert.ok( a.barycoordFromPoint( a.midpoint() ).distanceTo( new GLMath.Vector3( 1/3, 1/3, 1/3 ) ) < 0.0001, "Passed!" );
...
QUnit.test( "containsPoint" , function( assert ) {
	...
	assert.ok( ! a.containsPoint( new GLMath.Vector3( -1, -1, -1 ) ), "Passed!" );
...
QUnit.test( "closestPointToPoint" , function( assert ) {
	...
	var a = new GLMath.Triangle( new GLMath.Vector3( -1, 0, 0 ), new GLMath.Vector3( 1, 0, 0 ), new GLMath.Vector3( 0, 1, 0 ) );

	// point lies inside the triangle
	var b0 = a.closestPointToPoint( new GLMath.Vector3( 0, 0.5, 0 ) );
	assert.ok( b0.equals( new GLMath.Vector3( 0, 0.5, 0 ) ), "Passed!" );
	...
	b0 = a.closestPointToPoint( new GLMath.Vector3( -2, 0, 0 ) );
	assert.ok( b0.equals( new GLMath.Vector3( -1, 0, 0 ) ), "Passed!" );
	b0 = a.closestPointToPoint( new GLMath.Vector3( 2, 0, 0 ) );
	assert.ok( b0.equals( new GLMath.Vector3( 1, 0, 0 ) ), "Passed!" );
	b0 = a.closestPointToPoint( new GLMath.Vector3( 0, 2, 0 ) );
	assert.ok( b0.equals( new GLMath.Vector3( 0, 1, 0 ) ), "Passed!" );
	b0 = a.closestPointToPoint( new GLMath.Vector3( 0, -2, 0 ) );
	assert.ok( b0.equals( new GLMath.Vector3( 0, 0, 0 ) ), "Passed!" );
});

QUnit.test( "equals", function ( assert ) {

	var a = new GLMath.Triangle(
		new GLMath.Vector3( 1, 0, 0 ),
		new GLMath.Vector3( 0, 1, 0 ),
		new GLMath.Vector3( 0, 0, 1 )
	);
	var b = new GLMath.Triangle(
		new GLMath.Vector3( 0, 0, 1 ),
		new GLMath.Vector3( 0, 1, 0 ),
		new GLMath.Vector3( 1, 0, 0 )
	);
	var c = new GLMath.Triangle(
		new GLMath.Vector3( - 1, 0, 0 ),
		new GLMath.Vector3( 0, 1, 0 ),
		new GLMath.Vector3( 0, 0, 1 )
	);
