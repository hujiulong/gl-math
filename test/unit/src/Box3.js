...
QUnit.test( "getCenter" , function( assert ) {
	var a = new GLMath.Box3( zero3.clone(), zero3.clone() );
...
QUnit.test( "containsBox" , function( assert ) {
	var a = new GLMath.Box3( zero3.clone(), zero3.clone() );
	var b = new GLMath.Box3( zero3.clone(), one3.clone() );
	var c = new GLMath.Box3( one3.clone().negate(), one3.clone() );
...
QUnit.test( "getParameter" , function( assert ) {
	var a = new GLMath.Box3( zero3.clone(), one3.clone() );
	var b = new GLMath.Box3( one3.clone().negate(), one3.clone() );

	assert.ok( a.getParameter( new GLMath.Vector3( 0, 0, 0 ) ).equals( new GLMath.Vector3( 0, 0, 0 ) ), "Passed!" );
	assert.ok( a.getParameter( new GLMath.Vector3( 1, 1, 1 ) ).equals( new GLMath.Vector3( 1, 1, 1 ) ), "Passed!" );

	assert.ok( b.getParameter( new GLMath.Vector3( -1, -1, -1 ) ).equals( new GLMath.Vector3( 0, 0, 0 ) ), "Passed!" );
	assert.ok( b.getParameter( new GLMath.Vector3( 0, 0, 0 ) ).equals( new GLMath.Vector3( 0.5, 0.5, 0.5 ) ), "Passed!" );
	assert.ok( b.getParameter( new GLMath.Vector3( 1, 1, 1 ) ).equals( new GLMath.Vector3( 1, 1, 1 ) ), "Passed!" );
});
...
QUnit.test( "clampPoint" , function( assert ) {
	...
	assert.ok( a.clampPoint( new GLMath.Vector3( 0, 0, 0 ) ).equals( new GLMath.Vector3( 0, 0, 0 ) ), "Passed!" );
	assert.ok( a.clampPoint( new GLMath.Vector3( 1, 1, 1 ) ).equals( new GLMath.Vector3( 0, 0, 0 ) ), "Passed!" );
	assert.ok( a.clampPoint( new GLMath.Vector3( -1, -1, -1 ) ).equals( new GLMath.Vector3( 0, 0, 0 ) ), "Passed!" );

	assert.ok( b.clampPoint( new GLMath.Vector3( 2, 2, 2 ) ).equals( new GLMath.Vector3( 1, 1, 1 ) ), "Passed!" );
	assert.ok( b.clampPoint( new GLMath.Vector3( 1, 1, 1 ) ).equals( new GLMath.Vector3( 1, 1, 1 ) ), "Passed!" );
	assert.ok( b.clampPoint( new GLMath.Vector3( 0, 0, 0 ) ).equals( new GLMath.Vector3( 0, 0, 0 ) ), "Passed!" );
	assert.ok( b.clampPoint( new GLMath.Vector3( -1, -1, -1 ) ).equals( new GLMath.Vector3( -1, -1, -1 ) ), "Passed!" );
	assert.ok( b.clampPoint( new GLMath.Vector3( -2, -2, -2 ) ).equals( new GLMath.Vector3( -1, -1, -1 ) ), "Passed!" );
});
...
QUnit.test( "distanceToPoint" , function( assert ) {
	...
	assert.ok( a.distanceToPoint( new GLMath.Vector3( 0, 0, 0 ) ) == 0, "Passed!" );
	assert.ok( a.distanceToPoint( new GLMath.Vector3( 1, 1, 1 ) ) == Math.sqrt( 3 ), "Passed!" );
	assert.ok( a.distanceToPoint( new GLMath.Vector3( -1, -1, -1 ) ) == Math.sqrt( 3 ), "Passed!" );

	assert.ok( b.distanceToPoint( new GLMath.Vector3( 2, 2, 2 ) ) == Math.sqrt( 3 ), "Passed!" );
	assert.ok( b.distanceToPoint( new GLMath.Vector3( 1, 1, 1 ) ) == 0, "Passed!" );
	assert.ok( b.distanceToPoint( new GLMath.Vector3( 0, 0, 0 ) ) == 0, "Passed!" );
	assert.ok( b.distanceToPoint( new GLMath.Vector3( -1, -1, -1 ) ) == 0, "Passed!" );
	assert.ok( b.distanceToPoint( new GLMath.Vector3( -2, -2, -2 ) ) == Math.sqrt( 3 ), "Passed!" );
});
...
QUnit.test( "intersectsBox" , function( assert ) {
	...
	b.translate( new GLMath.Vector3( 2, 2, 2 ) );
	assert.ok( ! a.intersectsBox( b ), "Passed!" );
	assert.ok( ! b.intersectsBox( a ), "Passed!" );
	assert.ok( ! b.intersectsBox( c ), "Passed!" );
});
...
QUnit.test( "getBoundingSphere" , function( assert ) {
	...
	assert.ok( a.getBoundingSphere().equals( new GLMath.Sphere( zero3, 0 ) ), "Passed!" );
	assert.ok( b.getBoundingSphere().equals( new GLMath.Sphere( one3.clone().multiplyScalar( 0.5 ), Math.sqrt( 3 ) * 0.5 ) ), "Passed!" );
	assert.ok( c.getBoundingSphere().equals( new GLMath.Sphere( zero3, Math.sqrt( 12 ) * 0.5 ) ), "Passed!" );
});
...
QUnit.test( "applyMatrix4" , function( assert ) {
	...
	var b = new GLMath.Box3( zero3.clone(), one3.clone() );
	var c = new GLMath.Box3( one3.clone().negate(), one3.clone() );
	var d = new GLMath.Box3( one3.clone().negate(), zero3.clone() );

	var m = new GLMath.Matrix4().makeTranslation( 1, -2, 1 );
	var t1 = new GLMath.Vector3( 1, -2, 1 );
...
QUnit.test( "translate" , function( assert ) {
	...
	assert.ok( a.clone().translate( one3 ).equals( new GLMath.Box3( one3, one3 ) ), "Passed!" );
