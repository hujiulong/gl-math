...
QUnit.test( "getCenter" , function( assert ) {
	var a = new GLMath.Box2( zero2.clone(), zero2.clone() );

	assert.ok( a.getCenter().equals( zero2 ), "Passed!" );

	a = new GLMath.Box2( zero2, one2 );
...
QUnit.test( "containsBox" , function( assert ) {
	var a = new GLMath.Box2( zero2.clone(), zero2.clone() );
	var b = new GLMath.Box2( zero2.clone(), one2.clone() );
	var c = new GLMath.Box2( one2.clone().negate(), one2.clone() );
...
QUnit.test( "getParameter" , function( assert ) {
	var a = new GLMath.Box2( zero2.clone(), one2.clone() );
	var b = new GLMath.Box2( one2.clone().negate(), one2.clone() );

	assert.ok( a.getParameter( new GLMath.Vector2( 0, 0 ) ).equals( new GLMath.Vector2( 0, 0 ) ), "Passed!" );
	assert.ok( a.getParameter( new GLMath.Vector2( 1, 1 ) ).equals( new GLMath.Vector2( 1, 1 ) ), "Passed!" );

	assert.ok( b.getParameter( new GLMath.Vector2( -1, -1 ) ).equals( new GLMath.Vector2( 0, 0 ) ), "Passed!" );
	assert.ok( b.getParameter( new GLMath.Vector2( 0, 0 ) ).equals( new GLMath.Vector2( 0.5, 0.5 ) ), "Passed!" );
	assert.ok( b.getParameter( new GLMath.Vector2( 1, 1 ) ).equals( new GLMath.Vector2( 1, 1 ) ), "Passed!" );
});
...
QUnit.test( "clampPoint" , function( assert ) {
	...
	assert.ok( a.clampPoint( new GLMath.Vector2( 0, 0 ) ).equals( new GLMath.Vector2( 0, 0 ) ), "Passed!" );
	assert.ok( a.clampPoint( new GLMath.Vector2( 1, 1 ) ).equals( new GLMath.Vector2( 0, 0 ) ), "Passed!" );
	assert.ok( a.clampPoint( new GLMath.Vector2( -1, -1 ) ).equals( new GLMath.Vector2( 0, 0 ) ), "Passed!" );

	assert.ok( b.clampPoint( new GLMath.Vector2( 2, 2 ) ).equals( new GLMath.Vector2( 1, 1 ) ), "Passed!" );
	assert.ok( b.clampPoint( new GLMath.Vector2( 1, 1 ) ).equals( new GLMath.Vector2( 1, 1 ) ), "Passed!" );
	assert.ok( b.clampPoint( new GLMath.Vector2( 0, 0 ) ).equals( new GLMath.Vector2( 0, 0 ) ), "Passed!" );
	assert.ok( b.clampPoint( new GLMath.Vector2( -1, -1 ) ).equals( new GLMath.Vector2( -1, -1 ) ), "Passed!" );
	assert.ok( b.clampPoint( new GLMath.Vector2( -2, -2 ) ).equals( new GLMath.Vector2( -1, -1 ) ), "Passed!" );
});
...
QUnit.test( "distanceToPoint" , function( assert ) {
	...
	assert.ok( a.distanceToPoint( new GLMath.Vector2( 0, 0 ) ) == 0, "Passed!" );
	assert.ok( a.distanceToPoint( new GLMath.Vector2( 1, 1 ) ) == Math.sqrt( 2 ), "Passed!" );
	assert.ok( a.distanceToPoint( new GLMath.Vector2( -1, -1 ) ) == Math.sqrt( 2 ), "Passed!" );

	assert.ok( b.distanceToPoint( new GLMath.Vector2( 2, 2 ) ) == Math.sqrt( 2 ), "Passed!" );
	assert.ok( b.distanceToPoint( new GLMath.Vector2( 1, 1 ) ) == 0, "Passed!" );
	assert.ok( b.distanceToPoint( new GLMath.Vector2( 0, 0 ) ) == 0, "Passed!" );
	assert.ok( b.distanceToPoint( new GLMath.Vector2( -1, -1 ) ) == 0, "Passed!" );
	assert.ok( b.distanceToPoint( new GLMath.Vector2( -2, -2 ) ) == Math.sqrt( 2 ), "Passed!" );
});
...
QUnit.test( "intersectsBox" , function( assert ) {
	...
	b.translate( new GLMath.Vector2( 2, 2 ) );
	assert.ok( ! a.intersectsBox( b ), "Passed!" );
	assert.ok( ! b.intersectsBox( a ), "Passed!" );
	assert.ok( ! b.intersectsBox( c ), "Passed!" );
});
...
QUnit.test( "translate" , function( assert ) {
	...
	var b = new GLMath.Box2( zero2.clone(), one2.clone() );
	var c = new GLMath.Box2( one2.clone().negate(), one2.clone() );
	var d = new GLMath.Box2( one2.clone().negate(), zero2.clone() );

	assert.ok( a.clone().translate( one2 ).equals( new GLMath.Box2( one2, one2 ) ), "Passed!" );
